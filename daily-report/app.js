...
function buildReportParams_(kind){
  ...
  if(kind === 'r5'){
    const { dateStr, groups } = computeR5Groups_();
    return { groups: groups, date: dateStr };
  }
  return null;
}
